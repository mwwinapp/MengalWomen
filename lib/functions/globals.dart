...
const Color appFontColorPrimary = Colors.white;
...
const Color appBackgroundColorPrimary = Color.fromARGB(255, 25, 25, 25);
const Color appBackgroundColorSecondary = Color.fromARGB(255, 40, 40, 40);
